...
classNames = readtable(folder + "..\assets\CUB_200_2011_Subset20classes\classes.txt", ...
    'ReadVariableNames', false);
classNames.Properties.VariableNames = {'index', 'className'};

imageClassLabels = readtable(folder + "..\assets\CUB_200_2011_Subset20classes\image_class_labels.txt", ...
    'ReadVariableNames', false);
